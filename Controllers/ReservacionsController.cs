...
using ProyectoU3Eventos.Models;

namespace ProyectoU3Eventos.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ReservacionsController : ControllerBase
    {
        private readonly ProyectoCumplimientoEventosContext _context;

        public ReservacionsController(ProyectoCumplimientoEventosContext context)
        {
            _context = context;
        }
